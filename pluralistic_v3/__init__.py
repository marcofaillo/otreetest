...
#demographic and debriefing questions
    ...
    choice= models.IntegerField(choices=[[130, 'Option A: You get 130 CZK. The charity will receive 100 CZK with a probability of 10% and 0 with a probability of 90%. '], [80, 'Option B: You get 80 CZK. The charity will receive 60 CZK']])
    ...
    choice2= models.IntegerField(choices=[[130, 'Option A: You get 130 CZK. The charity will receive 100 CZK with a probability of 10% and 0 with a probability of 90%. '], [80, 'Option B: You get 80 CZK. The charity will receive 60 CZK']])
    pers_belief=models.IntegerField(choices=[[130, 'Option A: You get 130 CZK. The charity will receive 100 CZK with a probability of 10% and 0 with a probability of 90%.  '], [80, 'Option B: You get 80 CZK. The charity will receive 60 CZK']])
#    norm_belief=models.IntegerField(choices=[[130, 'Option A: You get 130 CZK. The charity will receive 100 CZK with a probability of 10% and 0 with a probability of 90%.  '], [80, 'Option B: You get 80 CZK. The charity will receive 60 CZK']]) #personal Beliefs
    emp_belief=models.IntegerField(choices=[[210, 'One chose Option A and the other chose Option B'], [260, 'They both chose Option A'], [160, 'They both chose Option B']]) #empirical expectations
    norm_belief=models.IntegerField(choices=[[210, 'One chose answered Option A and the other answered Option B'], [260, 'They both answered Option A'], [160, 'They both answered Option B']]) #normative believes
...
class WaitPage2(WaitPage):
    ...
    def after_all_players_arrive(subsession: Subsession):
        ...
        subsession.n_ten=[p.choice for p in subsession.get_players()].count(130)
        subsession.n_five=[p.choice for p in subsession.get_players()].count(80)
...
page_sequence = [ Instructions_1,WaitPage1, Choice, WaitPage2, Results, WaitPage1, Instructions_2, WaitPage1, Control,WaitPage1, Choice2, Beliefs, WaitPage3,WaitPage4, Punishment, WaitPage5,Agreement,FinalPunishment, WaitPage6,End ]
