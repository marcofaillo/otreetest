...
function mgslider(field, min, max, step) {
    ...
    this.uncertain = "Tokens that you decide to insure";
    this.certain = "Tokens that you decide not to insure";
...
mgslider.prototype.markup = function () {
    return "\
        <table id='" + this.id("wrapper") + "' class='mgslider-wrapper' border='0'>\
            <tr>\
                <td class='mgslider-limit'>" + "Tokens not insured" + "</td>\
                <td width='90%'>\
                ...
                <td class='mgslider-limit'>" + "Tokens  insured" + "</td>\
            </tr>\
...
mgslider.prototype.change = function (target, omit_hook) {
    ...
    var complementaryValue = 50 - value;
    document.getElementById(this.id("cur")).innerHTML = this.f2s(value, false);
    document.getElementById(this.id("line")).innerHTML = this.f2s(complementaryValue, false);
...
mgslider.prototype.reveal = function (event) {
    ...
    // Show the certain row after revealing the slider
    document.querySelector('#' + this.id("wrapper") + ' .mgslider-certain-row').style.display = 'table-row';
};
...
mgslider.prototype.set = function (new_value) {
    ...
    // Show the certain row after setting the slider value
    document.querySelector('#' + this.id("wrapper") + ' .mgslider-certain-row').style.display = 'table-row';
};
